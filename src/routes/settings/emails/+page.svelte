					...
					<div>
						...
						<div class="flex gap-3">
							<input
								...
								class="flex-1 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent"
							/>
							<button
								type="submit"
								class="rounded-lg bg-slate-900 text-white px-5 py-2 text-sm font-semibold hover:bg-slate-800 transition duration-150"
							>
								Add
							</button>
						</div>
				...
				<form onsubmit={handleSetPrimary}>
					<div>
						...
						<select
							...
							class="w-full rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent"
						>
